    ...
    <main>
      <div id="game-container">
        <ol id="players" className='highlight-player'>
          <Player onSaveNames={savePlayerName} initialName={PLAYERS.X} symbol="X" isActive= {activePlayer==='X'}/>
          <Player onSaveNames={savePlayerName} initialName={PLAYERS.O} symbol="O" isActive= {activePlayer==='O'}/>
        </ol>
